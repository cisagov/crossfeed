...
| [Have I been Pwned](https://haveibeenpwned.com/)                       | In progress | Passive        | Look up information from the Have I been Pwned API to determine potentially compromised email addresses for any .gov domain                                      |
| [DnsTwist](https://github.com/elceef/dnstwist)                         | In progress | Passive        | Domain name permutation engine for detecting homograph phishing attacks, typo squatting, and brand impersonation potentially compromised email addresses         |
| Root Domain Sync                                                       | In progress | Passive        | Fetch missing IP addresses per domain and sync to the database                                                                                                   |
| [LookingGlass](https://lookingglasscyber.com/solution/scoutprime/)     | In progress | Passive        | Look up Vulnerability & Malware information from the Looking Glass API                                                                                           |
