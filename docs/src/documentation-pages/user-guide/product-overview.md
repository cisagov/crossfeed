...
| [Have I been Pwned](https://haveibeenpwned.com/)                       | Implemeneted | Passive        | Look up information from the Have I been Pwned API to determine potentially compromised email addresses for any .gov domain                                      |
...
| [Cybersixgill](https://www.cybersixgill.com/)                          | Implemented    | Passive        | Connect to the Cybersixgill API for dark web threat intelligence. Only implemented for P&E.                                                                                                               |
| blocklist.de Domain Masquerading                                      | Implemented    | Passive        | Fetch DNSTwist data, checks IPs on blocklist.de. Only implemented for P&E.                                                                                                             |
| dotgov                          | Implemented    | Passive        | Create organizations based on root domains from the [dotgov registrar dataset](https://github.com/cisagov/dotgov-data).                                          |
...
**Note:** Scans are labeled "only implemented for P&E" if they can only be used by the P&E team (as they connect to the separate P&E database).

**Note:** The following scans are currently used by P&E: findomain, Have I Been Pwned, DNSTwist, LookingGlass, Shodan, Cybersixgill, blocklist.de
