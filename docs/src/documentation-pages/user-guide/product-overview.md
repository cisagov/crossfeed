...
| [Have I been Pwned](https://haveibeenpwned.com/)                       | Implemented | Passive        | Look up information from the Have I been Pwned API to determine potentially compromised email addresses                                                          |
