...
| Cybersixgill                                                           | Implemented | Passive        | Pulls data from Cybersixgill (dark web threat intelligence)                                                                                                      |
| blocklist.de                                                           | Implemented | Passive        | Checks domain IPs for abuse on blocklist.de                                                                                                                      |
