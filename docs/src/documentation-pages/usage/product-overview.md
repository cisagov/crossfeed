...
| [Findomain](https://github.com/Findomain/Findomain)                    | Implemented | Active         | Open source tool that integrates passive APIs in order to discover target subdomains                                                                             |
