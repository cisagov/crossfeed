...
pm2 start --interpreter none sudo -- -u mitmproxyuser -H bash -c 'mitmdump --mode transparent --showhost --set block_global=false -s worker/mitmproxy-sign-requests.py'
