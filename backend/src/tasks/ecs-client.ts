      ...
      try {
        ...
        const container = await this.docker!.createContainer({
          ...
          Env: [
            ...
            `PE_SHODAN_API_KEY_1=${process.env.PE_SHODAN_API_KEY_1}`,
            `PE_SHODAN_API_KEY_2=${process.env.PE_SHODAN_API_KEY_2}`,
            `PE_SHODAN_API_KEY_3=${process.env.PE_SHODAN_API_KEY_3}`,
