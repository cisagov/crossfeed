...
begin
		...
		if (sub_id is null) then
			...
			raise notice 'sub uid returned from new: %', sub_id;
	 	end if;
 	return sub_id;
end;
$$;
...
INSERT INTO organizations (name, cyhy_db_name, organizations_uid, report_on)
VALUES ('Department of Homeland Security', 'DHS', '56926ff0-0475-11ed-9265-02c6a3fe975b', true);

INSERT INTO organizations (name, cyhy_db_name, organizations_uid, report_on)
VALUES ('Department of State', 'DOS', '96926ff0-0475-11ed-9265-02c6a3fe975b', true);

INSERT INTO data_source(name, description, last_run, data_source_uid)
VALUES ('DNSTwist', 'Domain Permutations', '2022-03-14', '26926ff0-0475-11ed-9265-02c6a3fe975b');

INSERT INTO root_domains (organizations_uid, root_domain, data_source_uid)
VALUES ('56926ff0-0475-11ed-9265-02c6a3fe975b', 'dhs.gov', '26926ff0-0475-11ed-9265-02c6a3fe975b');

INSERT INTO root_domains (organizations_uid, root_domain, data_source_uid)
VALUES ('56926ff0-0475-11ed-9265-02c6a3fe975b', 'fema.gov', '26926ff0-0475-11ed-9265-02c6a3fe975b');

INSERT INTO root_domains (organizations_uid, root_domain, data_source_uid)
VALUES ('96926ff0-0475-11ed-9265-02c6a3fe975b', 'state.gov', '26926ff0-0475-11ed-9265-02c6a3fe975b');
...
export const handler: Handler = async (event) => {
  ...
  try {
    await connection.query(
      `DROP DATABASE IF EXISTS ${process.env.PE_DB_NAME};`
    );
  } catch (e) {
    console.log(
      "Drop database failed. This usually means that the database already exists, so you're OK if that was the case. Here's the exact error:",
      e
    );
  }
  try {
