      ...
      parsed: {
        ...
        subject_key_info: {
          ecdsa_public_key: {
            ...
            pub:
              'BK/RnLux41uEKK+IpV0Dz9URFUwMC2cUlhJHvd/GZdKqgibn3YzzeEyiIUwHjnHuEgLRI6DfSFtGHBFYYw0rQsM=',
