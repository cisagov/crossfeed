  ...
  "Statement": [
    ...
    },
    {
        ...
        "Resource": [
          ...
          "${data.aws_ssm_parameter.pe_shodan_api_key_1.arn}",
          "${data.aws_ssm_parameter.pe_shodan_api_key_2.arn}",
          "${data.aws_ssm_parameter.pe_shodan_api_key_3.arn}",
...
[
  {
    ...
    "secrets": [
      ...
      {
        "name": "PE_SHODAN_API_KEY",
        "valueFrom": "${data.aws_ssm_parameter.pe_shodan_api_key.arn}"
      },
      {
        "name": "HIBP_API_KEY",
...
data "aws_ssm_parameter" "pe_shodan_api_key" { name = var.ssm_pe_shodan_api_key }
