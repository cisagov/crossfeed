...
module "crossfeed" {
  ...
  # webscraper_bucket_name            = "crossfeed-staging-webscraper-dds"
  webscraper_bucket_name            = "crossfeed-dds-staging-webscraper"
  export_bucket_name                = "cisa-crossfeed-staging-exports-dds"
